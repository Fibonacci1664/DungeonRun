...
import com.davegreen.state.LevelManager;
...
public class LevelPanel extends JPanel implements KeyListener, MouseListener
{
    ...
    /**
     * Initialises the Panels Swing properties
     */
       ...
       //
        while(isRunning)
        {
            ...
            if(!isPaused)
            {
                ...
                drawTime = (deltaT/1_000_000_000);  // Conversion factor : nano seconds - seconds = / by 1 billion.
                ...
                waitT = TARGET_UPDATE_TIME - deltaT / 1_000_000_000;
